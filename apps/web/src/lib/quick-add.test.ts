...
describe("buildCreateInput — merge precedence", () => {
  ...
  it("seeds when_date and never emits both when_date and when_bucket", () => {
    // The section seeds a date; the user types a soft bucket → the column wins.
    const out = buildCreateInput("ship it /someday", { when_date: "2026-06-20" }, REF);
