...
**The sidebar section and the mobile cart button appear only once a list exists.**
A permanent heading for an unused feature is exactly the clutter this design
argues against.
